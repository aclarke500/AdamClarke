<template>
  <div class="portfolio">
    <p>Here I've listed some of the projects I've built that best demonstrate my abilites and interests. With the exception of Verus, all of these
...
const verusProject = {
  title: 'Verus AMB',
  description: [
    "Veurs AMB is a company I co-founded in first year. It's a VueFire application that serves to automate and optimize billing practices. Physicians simply take a photo of their daily schedule, and Veru selects the most appropriate billing option based on the 1000 page OHIP billing manual. The app then generates a billing report, and sends it to the physician's email. The app is currently in beta testing, and is scheduled to pilot at the Kingston General Hospital in the coming months." 
],
photoUrl:"https://i.ibb.co/ZXxzjC1/DALL-E-2023-12-21-13-09-35-A-profile-picture-for-an-innovative-automated-medical-billing-app-inspire.png",
...
"This is a project in AI generated content. I did not like going to my OS class, nor did I have the time to read the textbook. I used chatGPT to skim my textbook, and I passed in my assigned readings and asked it to make notes in html. From there, I put the notes it generated onto a website, and modified it slightly. Most of the code, styling, and all of the images and art associated with it are AI generated. As much as it was about studying for my OS class, it was also about leveraging AI to automate work as a developer."
  ...
  photoUrl: "https://i.ibb.co/Z12cPjW/DALL-E-2023-12-21-11-43-51-An-icon-for-an-operating-systems-study-website-showcasing-a-complex-and-v.png",
}
...
const classificationProject = {
  ...
  photoUrl: 'https://i.ibb.co/Wc8q74L/runtimes.png',
  websiteURL:null,
}
...
const arduinoTwosComplementProject = {
  ...
  photoUrl: "https://i.ibb.co/9gmgRTT/arduino-proj-photo.png",
